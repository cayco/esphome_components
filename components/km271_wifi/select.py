...
#            }),
            ...
            cv.Optional(CONF_HC1_SWT_SWITCH): select.SELECT_SCHEMA.extend({
                cv.GenerateID(): cv.declare_id(BuderusParamSelect),
                cv.Optional(CONF_OPTIONS, default={9: 'Lato', 10: '10°C', 11: '11°C', 12: '12°C', 13: '13°C', 14: '14°C', 15: '15°C', 16: '16°C', 17: '17°C', 18: '18°C', 19: '19°C', 20: '20°C', 21: '21°C', 22: '22°C', 23: '23°C', 24: '24°C', 25: '25°C', 26: '26°C', 27: '27°C', 28: '28°C', 29: '29°C', 30: '30°C', 31: 'Winter'}): ensure_option_map
            }),
            cv.GenerateID(CONF_KM271_ID): cv.use_id(KM271),
            cv.Optional(CONF_HC1_HEATING_PROGRAM): select.SELECT_SCHEMA.extend({
                cv.GenerateID(): cv.declare_id(BuderusParamSelect),
                cv.Optional(CONF_OPTIONS, default={0: 'Własny', 1: 'Rodzina', 2: 'Wcześnie', 3: 'Późno', 4: 'Wcześnie rano', 5: 'Późno rano', 6: 'Południe', 7: 'Raz', 8: 'Wcześnie'}): ensure_option_map
            }),
            cv.GenerateID(CONF_KM271_ID): cv.use_id(KM271),
            cv.Optional(CONF_HC1_OPMODE): select.SELECT_SCHEMA.extend({
                cv.GenerateID(): cv.declare_id(BuderusParamSelect),
                cv.Optional(CONF_OPTIONS, default={0: 'Noc', 1: 'Dzień', 2: 'Auto'}): ensure_option_map
            }),
            cv.GenerateID(CONF_KM271_ID): cv.use_id(KM271),
            cv.Optional(CONF_HC1_LOWERING_TYPE): select.SELECT_SCHEMA.extend({
                cv.GenerateID(): cv.declare_id(BuderusParamSelect),
                cv.Optional(CONF_OPTIONS, default={0: 'Wyłączony', 1: 'Zredukowany', 2: 'Zatrzymany', 3: 'Stop'}): ensure_option_map
            }),
            cv.GenerateID(CONF_KM271_ID): cv.use_id(KM271),
            cv.Optional(CONF_HC1_HEATINGS_TYPE): select.SELECT_SCHEMA.extend({
                cv.GenerateID(): cv.declare_id(BuderusParamSelect),
                cv.Optional(CONF_OPTIONS, default={0: 'Od', 1: 'Grzejnik'}): ensure_option_map
            }),
            ...
            cv.Optional(CONF_HC2_HEATINGS_TYPE): select.SELECT_SCHEMA.extend({
                cv.GenerateID(): cv.declare_id(BuderusParamSelect),
                cv.Optional(CONF_OPTIONS, default={0: 'Od', 1: 'Grzejnik', 3: 'Podłoga'}): ensure_option_map
            }),

            cv.Optional(CONF_WW_OPMODE): select.SELECT_SCHEMA.extend({
                cv.GenerateID(): cv.declare_id(BuderusParamSelect),
                cv.Optional(CONF_OPTIONS, default={0: 'Od', 1: 'Ein', 2: 'Auto'}): ensure_option_map
            }),
